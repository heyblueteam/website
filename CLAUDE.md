...
- We're shifting from B2B SaaS Focussed on SMEs to an Enterprise-only strategy. 
- The idea is to make a site with a high degree of polish to be on a world class level like Palantir, Stripe, OpenAI, and Linear, Figma, and so on. 
