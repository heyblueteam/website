...
| color | String | Цветовой код из доступных опций |  |
...
```
Применимо к: `TEXT_SINGLE`, `TEXT_MULTI`, `URL`, `EMAIL`
...
```
Применимо к: `NUMBER`, `CURRENCY`, `PERCENT`, `RATING`
...
```
Применимо к: `SELECT_SINGLE`, `SELECT_MULTI`
...
Дополнительные разрешения для пользовательских полей могут применяться для `setTodoCustomField` в зависимости от конфигурации роли.
