---
title: A História dos Quadros Kanban
description: Aprenda a história dos Quadros Kanban e como eles evoluíram de fábricas para ferramentas digitais flexíveis.
category: "Best Practices"
date: 2024-07-23
---


Na Blue, adoramos [quadros Kanban](/platform/features/kanban-board).
...
1. **[Listas (ou Colunas)](https://documentation.blue.cc/records/lists)**: Estas representam os diferentes estágios do seu fluxo de trabalho. Por exemplo, um quadro Kanban básico pode ter listas rotuladas como "A Fazer", "Em Progresso" e "Concluído".
2. **[Cartões](/platform/features/records)**: Estes representam tarefas ou itens de trabalho individuais. Cada cartão normalmente contém informações sobre a tarefa, como sua descrição, quem é responsável por ela e sua data de entrega.
...
Apesar de sua ampla adoção, o Kanban não está isento de equívocos. Alguns acreditam erroneamente que é difícil de configurar ou não é poderoso o suficiente para *"trabalho sério"* que sempre requer longos planos escritos e [Gráficos de Gantt](/platform/features/timeline-gantt-charts). Na realidade, a simplicidade do Kanban *é* uma de suas maiores forças, tornando-o adaptável a várias escalas e complexidades de trabalho.
...
A história do Kanban começa nas movimentadas fábricas do Japão pós-Segunda Guerra Mundial, especificamente na Toyota Motor Corporation. No final da década de 1940, um jovem engenheiro industrial chamado [Taiichi Ohno](https://en.wikipedia.org/wiki/Taiichi_Ohno) foi encarregado de melhorar a eficiência da manufatura da Toyota.

![](/insights/taiichi-ohno.jpg)

Ohno identificou sete fontes de desperdício na produção, que agora são reconhecidas como cruciais na [manufatura enxuta](https://en.wikipedia.org/wiki/Lean_manufacturing):

1. Atraso, espera ou tempo gasto em uma fila sem valor agregado
2. Produzir mais do que você precisa
3. Processamento excessivo ou realização de atividades sem valor agregado
4. Transporte
5. Movimento ou ação desnecessária
6. Estoque
...
1. Você é um custo. Primeiro, reduza o desperdício.
2. Primeiro diga: "Eu posso fazer isso." E tente antes de tudo.
3. O local de trabalho é um professor. Você só pode encontrar respostas no local de trabalho.
4. Faça qualquer coisa imediatamente. Começar algo agora é a única maneira de vencer.
5. Uma vez que você começa algo, persevere com isso. Não desista até terminar.
6. Explique coisas difíceis de uma maneira fácil de entender. Repita coisas que são fáceis de entender.
7. O desperdício é oculto. Não o esconda. Torne os problemas visíveis.
8. Movimentos sem valor são iguais a encurtar a vida de alguém.
9. Re-improve o que foi melhorado para mais melhorias.
10. A sabedoria é dada igualmente a todos. O ponto é se alguém pode exercitá-la.
...
O experimento de Anderson foi um sucesso. A equipe viu melhorias dramáticas em [produtividade e moral](/insights/great-teamwork). Isso marcou o nascimento do que viria a ser conhecido como "Kanban para trabalho do conhecimento" ou "Kanban de Software".
...
Um marco significativo na difusão do Kanban no desenvolvimento de software e além foi o lançamento do [Trello](/insights/trello) em 2011. O Trello, uma [plataforma de gerenciamento de projetos baseada na web](/solutions/use-case/project-management), popularizou o conceito de [quadros Kanban digitais](/platform/features/kanban-board) para um amplo público.
...
O sucesso do Trello desencadeou uma onda de ferramentas semelhantes, como [Blue](/), e logo, os recursos de quadros Kanban tornaram-se uma oferta padrão em muitas [soluções de software de gerenciamento de projetos](/solutions/use-case/project-management):
...
À medida que o Kanban continuava a evoluir no mundo do software, começou a influenciar práticas de gerenciamento de projetos em várias indústrias. [Até mesmo não-gerentes de projetos começaram a se tornar gerentes de projetos!](/insights/project-management-basics-guide)
...
Na [Blue](/), estamos ativamente construindo o futuro dos quadros Kanban, e é por isso que é tão importante entender sua história. À medida que trabalhamos para cumprir nossa missão de construir o [melhor software de gerenciamento de projetos do mundo](/solutions/use-case/project-management), vemos algumas tendências surgindo no futuro:
...
Então é isso! Esperamos que você tenha gostado de aprender sobre a história dos quadros Kanban. Se você está ativamente buscando implementar um software de quadro kanban em sua equipe, [sinta-se à vontade para se inscrever em um teste gratuito da Blue.](https://app.blue.cc)