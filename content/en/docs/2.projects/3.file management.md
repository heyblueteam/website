...
Files uploaded in the description area of the records are not listed in the files tab, as these are typically used for temporary notes. We recommend uploading files to a <a href="/docs/custom-fields/file">specific file custom field</a> instead.
::
