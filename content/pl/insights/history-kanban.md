---
title: Historia Tablic Kanban
description: Poznaj historię tablic Kanban i dowiedz się, jak ewoluowały z fabryk w elastyczne narzędzia cyfrowe.
category: "Best Practices"
date: 2024-07-23
---


W Blue uwielbiamy [tablice Kanban](/platform/features/kanban-board).
...
1. **[Listy (lub Kolumny)](https://documentation.blue.cc/records/lists)**: Reprezentują różne etapy w twoim przepływie pracy. Na przykład, podstawowa tablica Kanban może mieć listy oznaczone jako "Do zrobienia", "W trakcie" i "Zrobione".
2. **[Karty](/platform/features/records)**: Reprezentują poszczególne zadania lub elementy pracy. Każda karta zazwyczaj zawiera informacje o zadaniu, takie jak jego opis, kto jest za nie odpowiedzialny i termin wykonania.
...
Historia Kanban zaczyna się w tętniących życiem fabrykach Japonii po II wojnie światowej, a konkretnie w Toyota Motor Corporation. Pod koniec lat 40. XX wieku, młody inżynier przemysłowy o imieniu [Taiichi Ohno](https://en.wikipedia.org/wiki/Taiichi_Ohno) został wyznaczony do poprawy efektywności produkcji Toyoty.

![](/insights/taiichi-ohno.jpg)

Ohno zidentyfikował siedem źródeł marnotrawstwa w produkcji, które są teraz uznawane za kluczowe w [szczupłej produkcji](https://en.wikipedia.org/wiki/Lean_manufacturing):

1. Opóźnienie, czekanie lub czas spędzony w kolejce bez dodawania wartości
2. Produkowanie więcej niż potrzebujesz
3. Nadmierna obróbka lub podejmowanie działań, które nie dodają wartości
4. Transport
5. Niepotrzebny ruch lub ruch
6. Zapasy
7. Wady w produkcie
...
1. Jesteś kosztem. Najpierw zredukuj marnotrawstwo.
2. Najpierw powiedz: "Mogę to zrobić." I spróbuj przed wszystkim.
3. Miejsce pracy jest nauczycielem. Odpowiedzi można znaleźć tylko w miejscu pracy.
4. Rób wszystko natychmiast. Rozpoczęcie czegoś teraz jest jedynym sposobem na zwycięstwo.
5. Gdy zaczniesz coś, wytrwaj w tym. Nie poddawaj się, aż to skończysz.
6. Wyjaśniaj trudne rzeczy w sposób łatwy do zrozumienia. Powtarzaj rzeczy, które są łatwe do zrozumienia.
7. Marnotrawstwo jest ukryte. Nie ukrywaj go. Uczyń problemy widocznymi.
8. Ruchy bez wartości są równe skracaniu życia.
9. Ponownie popraw to, co zostało poprawione, w celu dalszej poprawy.
10. Mądrość jest dana wszystkim równo. Kluczowe jest to, czy można ją wykorzystać.
...
Eksperyment Andersona zakończył się sukcesem. Zespół zauważył dramatyczne [poprawy w wydajności i morale](/insights/great-teamwork). To oznaczało narodziny tego, co miało stać się znane jako "Kanban dla pracy wiedzy" lub "Kanban oprogramowania".
...
Znaczącym kamieniem milowym w rozprzestrzenieniu się Kanban w rozwoju oprogramowania i nie tylko było uruchomienie [Trello](/insights/trello) w 2011 roku. Trello, [internetowa platforma do zarządzania projektami](/solutions/use-case/project-management), spopularyzowało koncepcję [cyfrowych tablic Kanban](/platform/features/kanban-board) dla szerokiej publiczności.
...
Sukces Trello wywołał falę podobnych narzędzi, takich jak [Blue](/), a wkrótce funkcje tablic Kanban stały się standardową ofertą w wielu [rozwiązaniach do zarządzania projektami](/solutions/use-case/project-management):
...
Gdy Kanban nadal ewoluował w świecie oprogramowania, zaczął wpływać na praktyki zarządzania projektami w różnych branżach. [Nawet osoby, które nie były menedżerami projektów, zaczęły stawać się menedżerami projektów!](/insights/project-management-basics-guide)
...
W [Blue](/) aktywnie budujemy przyszłość tablic Kanban, dlatego tak ważne jest zrozumienie ich historii. Gdy pracujemy nad spełnieniem naszej misji budowania [najlepszego oprogramowania do zarządzania projektami na świecie](/solutions/use-case/project-management), dostrzegamy kilka nadchodzących trendów:
...
To wszystko! Mamy nadzieję, że podobało Ci się poznawanie historii tablic Kanban. Jeśli aktywnie szukasz oprogramowania do wdrożenia tablicy kanban w swoim zespole, [nie wahaj się zarejestrować na bezpłatny okres próbny Blue.](https://app.blue.cc)