---
title: La Storia delle Lavagne Kanban
description: Scopri la storia delle Lavagne Kanban e come si siano evolute dai pavimenti delle fabbriche a strumenti digitali flessibili.
category: "Best Practices"
date: 2024-07-23
---


In Blue, amiamo le [lavagne Kanban](/platform/features/kanban-board).
...
1. **[Liste (o Colonne)](https://documentation.blue.cc/records/lists)**: Queste rappresentano le diverse fasi del tuo flusso di lavoro. Ad esempio, una lavagna Kanban di base potrebbe avere liste etichettate "Da Fare", "In Corso" e "Fatto".
2. **[Schede](/platform/features/records)**: Queste rappresentano singole attività o elementi di lavoro. Ogni scheda contiene tipicamente informazioni sull'attività, come la sua descrizione, chi è responsabile e la sua data di scadenza.
...
La storia del Kanban inizia nelle fabbriche brulicanti del Giappone del dopoguerra, specificamente alla Toyota Motor Corporation. Negli anni '40, un giovane ingegnere industriale di nome [Taiichi Ohno](https://en.wikipedia.org/wiki/Taiichi_Ohno) fu incaricato di migliorare l'efficienza produttiva della Toyota.

![](/insights/taiichi-ohno.jpg)

Ohno identificò sette fonti di spreco nella produzione, ora riconosciute come cruciali nella [produzione snella](https://en.wikipedia.org/wiki/Lean_manufacturing):

1. Ritardo, attesa o tempo speso in coda senza valore aggiunto
2. Produrre più di quanto necessario
3. Sovraelaborazione o intraprendere attività non a valore aggiunto
4. Trasporto
5. Movimento o azione non necessaria
6. Inventario
7. Difetti nel prodotto
...
1. Sei un costo. Prima riduci gli sprechi.
2. Prima dì: "Posso farlo." E prova prima di tutto.
3. Il posto di lavoro è un insegnante. Puoi trovare risposte solo nel posto di lavoro.
4. Fai tutto immediatamente. Iniziare qualcosa proprio ora è l'unico modo per vincere.
5. Una volta che inizi qualcosa, persevera. Non arrenderti finché non lo finisci.
6. Spiega le cose difficili in modo semplice. Ripeti le cose che sono facili da comprendere.
7. Gli sprechi sono nascosti. Non nasconderli. Rendi i problemi visibili.
8. I movimenti privi di valore equivalgono a accorciare la propria vita.
9. Ri-migliora ciò che è stato migliorato per ulteriori miglioramenti.
10. La saggezza è data a tutti in egual misura. Il punto è se uno può esercitarla.
...
L'esperimento di Anderson ebbe successo. Il team vide miglioramenti drammatici nella [produttività e nel morale](/insights/great-teamwork). Questo segnò la nascita di quello che sarebbe stato conosciuto come "Kanban per il lavoro della conoscenza" o "Software Kanban".
...
Un traguardo significativo nella diffusione del Kanban nello sviluppo software e oltre fu il lancio di [Trello](/insights/trello) nel 2011. Trello, una [piattaforma di gestione progetti basata sul web](/solutions/use-case/project-management), ha reso popolare il concetto di [lavagne Kanban digitali](/platform/features/kanban-board) per un vasto pubblico.
...
Il successo di Trello ha innescato un'ondata di strumenti simili, come [Blue](/), e presto, le funzionalità delle lavagne Kanban divennero un'offerta standard in molte [soluzioni software di gestione progetti](/solutions/use-case/project-management):
...
Mentre il Kanban continuava a evolversi nel mondo del software, iniziò a influenzare le pratiche di gestione dei progetti in vari settori. [Anche i non project manager iniziarono a diventare project manager!](/insights/project-management-basics-guide)
...
In [Blue](/), stiamo attivamente costruendo il futuro delle lavagne Kanban, ed è per questo che è così importante comprendere la loro storia. Mentre lavoriamo per realizzare la nostra missione di costruire il [miglior software di gestione progetti al mondo](/solutions/use-case/project-management), vediamo alcune tendenze emergere nel futuro:
...
Ecco fatto! Speriamo che ti sia piaciuto scoprire la storia delle lavagne Kanban. Se stai cercando attivamente di implementare un software per lavagne Kanban nel tuo team, [sentiti libero di iscriverti a una prova gratuita di Blue.](https://app.blue.cc)