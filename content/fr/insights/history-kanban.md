---
title: L'histoire des tableaux Kanban
description: Découvrez l'histoire des tableaux Kanban et comment ils ont évolué des usines vers des outils numériques flexibles.
category: "Best Practices"
date: 2024-07-23
---


Chez Blue, nous adorons [les tableaux Kanban](/platform/features/kanban-board).
...
1. **[Listes (ou Colonnes)](https://documentation.blue.cc/records/lists)** : Elles représentent les différentes étapes de votre flux de travail. Par exemple, un tableau Kanban de base pourrait avoir des listes étiquetées "À faire", "En cours" et "Terminé".
2. **[Cartes](/platform/features/records)** : Elles représentent des tâches ou des éléments de travail individuels. Chaque carte contient généralement des informations sur la tâche, telles que sa description, la personne responsable et sa date d'échéance.
...
Malgré son adoption généralisée, Kanban n'est pas exempt de malentendus. Certains croient à tort qu'il est difficile à mettre en place ou pas assez puissant pour un *"travail sérieux"* qui nécessite toujours de longs plans écrits et des [diagrammes de Gantt](/platform/features/timeline-gantt-charts). En réalité, la simplicité de Kanban *est* l'une de ses plus grandes forces, la rendant adaptable à diverses échelles et complexités de travail.
...
L'histoire de Kanban commence dans les usines animées du Japon d'après-guerre, plus précisément chez Toyota Motor Corporation. À la fin des années 1940, un jeune ingénieur industriel nommé [Taiichi Ohno](https://en.wikipedia.org/wiki/Taiichi_Ohno) a été chargé d'améliorer l'efficacité de la fabrication chez Toyota.

![](/insights/taiichi-ohno.jpg)

Ohno a identifié sept sources de gaspillage dans la production, qui sont maintenant reconnues comme cruciales dans [la fabrication lean](https://en.wikipedia.org/wiki/Lean_manufacturing) :

1. Retard, attente ou temps passé dans une file d'attente sans valeur ajoutée
2. Produire plus que nécessaire
3. Surtraitement ou réalisation d'activités sans valeur ajoutée
4. Transport
5. Mouvement ou motion inutiles
6. Inventaire
7. Défauts dans le produit
...
1. Vous êtes un coût. Réduisez d'abord le gaspillage.
2. Dites d'abord : "Je peux le faire." Et essayez avant tout.
3. Le lieu de travail est un enseignant. Vous ne pouvez trouver des réponses que sur le lieu de travail.
4. Faites tout immédiatement. Commencer quelque chose maintenant est le seul moyen de gagner.
5. Une fois que vous commencez quelque chose, persévérez. Ne renoncez pas tant que vous ne l'avez pas terminé.
6. Expliquez les choses difficiles de manière simple. Répétez les choses faciles à comprendre.
7. Le gaspillage est caché. Ne le cachez pas. Rendez les problèmes visibles.
8. Les mouvements sans valeur équivalent à écourter sa vie.
9. Réaméliorez ce qui a été amélioré pour de nouvelles améliorations.
10. La sagesse est donnée également à tout le monde. L'important est de savoir si l'on peut l'exercer.
...
L'expérience d'Anderson a été un succès. L'équipe a connu des [améliorations spectaculaires en matière de productivité et de moral](/insights/great-teamwork). Cela a marqué la naissance de ce qui allait être connu sous le nom de "Kanban pour le travail intellectuel" ou "Kanban logiciel".
...
Un jalon significatif dans la diffusion de Kanban dans le développement logiciel et au-delà a été le lancement de [Trello](/insights/trello) en 2011. Trello, une [plateforme de gestion de projet basée sur le web](/solutions/use-case/project-management), a popularisé le concept de [tableaux Kanban numériques](/platform/features/kanban-board) pour un large public.
...
Le succès de Trello a déclenché une vague d'outils similaires, tels que [Blue](/), et bientôt, les fonctionnalités de tableau Kanban sont devenues une offre standard dans de nombreuses [solutions logicielles de gestion de projet](/solutions/use-case/project-management) :
...
Alors que Kanban continuait d'évoluer dans le monde du logiciel, il a commencé à influencer les pratiques de gestion de projet dans divers secteurs. [Même les non-gestionnaires de projet ont commencé à devenir des gestionnaires de projet !](/insights/project-management-basics-guide)
...
Chez [Blue](/), nous construisons activement l'avenir des tableaux Kanban, et c'est pourquoi il est si important de comprendre leur histoire. Alors que nous travaillons à réaliser notre mission de construire le [meilleur logiciel de gestion de projet au monde.](/solutions/use-case/project-management), nous voyons quelques tendances émerger dans le futur :
...
Voilà ! Nous espérons que vous avez apprécié d'apprendre sur l'histoire des tableaux Kanban. Si vous cherchez activement à mettre en œuvre un logiciel de tableau Kanban dans votre équipe, [n'hésitez pas à vous inscrire pour un essai gratuit de Blue.](https://app.blue.cc) 
