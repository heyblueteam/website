---
title: De Geschiedenis van Kanban-borden
description: Leer de geschiedenis van Kanban-borden en hoe ze zijn geëvolueerd van fabrieksvloeren naar flexibele digitale tools.
category: "Best Practices"
date: 2024-07-23
---


Bij Blue houden we van [Kanban-borden](/platform/features/kanban-board). 
...
1. **[Lijsten (of Kolommen)](https://documentation.blue.cc/records/lists)**: Deze vertegenwoordigen de verschillende fasen in je workflow. Een basis Kanban-bord kan bijvoorbeeld lijsten hebben met de labels "Te Doen", "In Uitvoering" en "Klaar."
2. **[Kaarten](/platform/features/records)**: Deze vertegenwoordigen individuele taken of werkitems. Elke kaart bevat doorgaans informatie over de taak, zoals de beschrijving, wie ervoor verantwoordelijk is en de vervaldatum.
...
Het verhaal van Kanban begint in de drukke fabrieken van Japan na de Tweede Wereldoorlog, specifiek bij Toyota Motor Corporation. In de late jaren 1940 kreeg een jonge industriële ingenieur genaamd [Taiichi Ohno](https://en.wikipedia.org/wiki/Taiichi_Ohno) de taak om de productie-efficiëntie van Toyota te verbeteren. 

![](/insights/taiichi-ohno.jpg)

Ohno identificeerde zeven bronnen van verspilling in de productie, die nu worden erkend als cruciaal in [lean manufacturing](https://en.wikipedia.org/wiki/Lean_manufacturing):

1. Vertraging, wachten of tijd doorbrengen in een rij zonder dat er waarde wordt toegevoegd
2. Meer produceren dan je nodig hebt
3. Overbewerking of het ondernemen van niet-waarde toevoegende activiteiten
4. Transport
5. Onnodige beweging of actie
6. Voorraad
7. Defecten in het product
...
1. Je bent een kost. Verminder eerst verspilling.
2. Zeg eerst: "Ik kan het doen." En probeer alles voordat je iets doet.
3. De werkplek is een leraar. Je kunt antwoorden alleen op de werkplek vinden.
4. Doe alles onmiddellijk. Iets nu beginnen is de enige manier om te winnen.
5. Zodra je iets begint, volhard erin. Geef niet op totdat je het hebt afgemaakt.
6. Leg moeilijke dingen eenvoudig uit. Herhaal dingen die gemakkelijk te begrijpen zijn.
7. Verspilling is verborgen. Verberg het niet. Maak problemen zichtbaar.
8. Waarde-loze bewegingen zijn gelijk aan het verkorten van iemands leven.
9. Verbeter wat is verbeterd voor verdere verbetering.
10. Wijsheid is gelijk verdeeld over iedereen. Het punt is of iemand het kan uitoefenen.
...
Anderson's experiment was een succes. Het team zag dramatische [verbeteringen in productiviteit en moraal](/insights/great-teamwork). Dit markeerde de geboorte van wat bekend zou komen te staan als "Kanban voor kenniswerk" of "Software Kanban."
...
Een belangrijke mijlpaal in de verspreiding van Kanban in softwareontwikkeling en daarbuiten was de lancering van [Trello](/insights/trello) in 2011. Trello, een [webgebaseerd projectmanagementplatform](/solutions/use-case/project-management), populariseerde het concept van [digitale Kanban-borden](/platform/features/kanban-board) voor een breed publiek.
...
Het succes van Trello leidde tot een golf van soortgelijke tools, zoals [Blue](/), en al snel werden Kanban-bordfuncties een standaardaanbod in veel [projectmanagementsoftware-oplossingen](/solutions/use-case/project-management):
...
Naarmate Kanban bleef evolueren in de softwarewereld, begon het ook projectmanagementpraktijken in verschillende industrieën te beïnvloeden. [Zelfs niet-projectmanagers begonnen projectmanagers te worden!](/insights/project-management-basics-guide)
...
Bij [Blue](/) bouwen we actief aan de toekomst van Kanban-borden, en daarom is het zo belangrijk om hun geschiedenis te begrijpen. Terwijl we aan de slag gaan met het vervullen van onze missie om de [beste projectmanagementsoftware ter wereld te bouwen.](/solutions/use-case/project-management), zien we een paar trends die in de toekomst opkomen:
...
Dat is het! We hopen dat je het leuk vond om te leren over de geschiedenis van Kanban-borden. Als je actief op zoek bent naar het implementeren van een kanban-bordsoftware in je team, [voel je vrij om je aan te melden voor een gratis proefversie van Blue.](https://app.blue.cc) 