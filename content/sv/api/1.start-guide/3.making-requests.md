---
title: Göra Förfrågningar
description: Blue API använder GraphQL för att erbjuda ett flexibelt och effektivt sätt att interagera med vår API.
---

## Läsning av Data
Du kan kopiera och klistra in följande kod curl-kommando i din terminal för att komma igång: .
...
```
Eller prova våra exempel i Python eller Node.
...
@@CB##63726fb7-36c0-4b18-b57f-3ac4af8d8833##CB@@json [Sample response for project list]
{
  "data": {
    "projectList": {
      "items": [
...
print(response.json())  # To see the response
@@CB##d0320a20-aa9e-447e-b3d0-4b20c0f2a8ff##CB@@javascript [node]
const axios = require('axios');
...
@@CB##10c923af-d360-4dab-91f5-d8b835b88a19##CB@@
...
@@CB##b4436155-b322-43c5-ab21-d17056504bcf##CB@@
...
Always check for the `errors` array in the response before processing `data`. If `errors` is present, the operation failed and `data` kan vara null.