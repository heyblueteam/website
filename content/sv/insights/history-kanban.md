---
title: Historien om Kanban-tavlor
description: Lär dig historien om Kanban-tavlor och hur de utvecklades från fabriksgolv till flexibla digitala verktyg.
category: "Best Practices"
date: 2024-07-23
---


På Blue älskar vi [Kanban-tavlor](/platform/features/kanban-board).
...
1. **[Listor (eller Kolumner)](https://documentation.blue.cc/records/lists)**: Dessa representerar de olika stegen i ditt arbetsflöde. Till exempel kan en grundläggande Kanban-tavla ha listor märkta "Att Göra", "Pågående" och "Färdig".
2. **[Kort](/platform/features/records)**: Dessa representerar individuella uppgifter eller arbetsobjekt. Varje kort innehåller vanligtvis information om uppgiften, såsom dess beskrivning, vem som är ansvarig för den och dess förfallodatum.
...
Historien om Kanban börjar i de livliga fabrikerna i Japan efter andra världskriget, specifikt på Toyota Motor Corporation. I slutet av 1940-talet fick en ung industriingenjör vid namn [Taiichi Ohno](https://en.wikipedia.org/wiki/Taiichi_Ohno) i uppdrag att förbättra Toyotas tillverkningseffektivitet.

![](/insights/taiichi-ohno.jpg)

Ohno identifierade sju källor till slöseri i produktionen, som nu erkänns som avgörande inom [lean manufacturing](https://en.wikipedia.org/wiki/Lean_manufacturing):

1. Fördröjning, väntan eller tid som spenderas i kö utan att något värde tillförs
2. Att producera mer än vad som behövs
3. Överbearbetning eller att utföra aktiviteter utan värde
4. Transport
5. Onödig rörelse eller motion
6. Lager
7. Defekter i produkten
...
1. Du är en kostnad. Först minska slöseri.
2. Säg först, "Jag kan göra det." Och försök innan allt annat.
3. Arbetsplatsen är en lärare. Du kan bara hitta svar i arbetsplatsen.
4. Gör allt omedelbart. Att börja något just nu är det enda sättet att vinna.
5. När du väl har påbörjat något, håll fast vid det. Ge inte upp förrän du har avslutat det.
6. Förklara svåra saker på ett lättförståeligt sätt. Upprepa saker som är lätta att förstå.
7. Slöseri är dolt. Dölja det inte. Gör problem synliga.
8. Värdelösa rörelser är lika med att förkorta ens liv.
9. Förbättra det som har förbättrats för ytterligare förbättring.
10. Visdom ges lika till alla. Poängen är om man kan utöva den.
...
Andersons experiment var en succé. Teamet såg dramatiska [förbättringar i produktivitet och moral](/insights/great-teamwork). Detta markerade födelsen av vad som skulle komma att kallas "Kanban för kunskapsarbete" eller "Mjukvaru-Kanban."
...
En betydande milstolpe i spridningen av Kanban inom mjukvaruutveckling och bortom var lanseringen av [Trello](/insights/trello) 2011. Trello, en [webbaserad projektledningsplattform](/solutions/use-case/project-management), populariserade konceptet med [digitala Kanban-tavlor](/platform/features/kanban-board) för en bred publik.
...
Trellos framgång utlöste en våg av liknande verktyg, såsom [Blue](/), och snart blev Kanban-tavelfunktioner en standardfunktion i många [projektledningsprogramvarulösningar](/solutions/use-case/project-management):
...
När Kanban fortsatte att utvecklas i mjukvaruvärlden började det påverka projektledningspraxis inom olika industrier. [Till och med icke-projektledare började bli projektledare!](/insights/project-management-basics-guide)
...
På [Blue](/) bygger vi aktivt framtiden för Kanban-tavlor, och det är därför det är så viktigt att förstå deras historia. När vi arbetar för att uppfylla vår mission att bygga den [bästa projektledningsprogramvaran i världen](/solutions/use-case/project-management), ser vi några trender som kommer i framtiden:
...
Så det var det! Vi hoppas att du har njutit av att lära dig om historien om Kanban-tavlor. Om du aktivt letar efter att implementera en Kanban-tavla-programvara i ditt team, [känn dig fri att registrera dig för en gratis provperiod av Blue.](https://app.blue.cc)