---
title: Sejarah Papan Kanban
description: Pelajari sejarah Papan Kanban, dan bagaimana mereka berevolusi dari lantai pabrik menjadi alat digital yang fleksibel.
category: "Best Practices"
date: 2024-07-23
---


Di Blue, kami menyukai [papan Kanban](/platform/features/kanban-board). 
...
1. **[Daftar (atau Kolom)](https://documentation.blue.cc/records/lists)**: Ini mewakili berbagai tahap dalam alur kerja Anda. Misalnya, papan Kanban dasar mungkin memiliki daftar yang diberi label "To Do," "In Progress," dan "Done."
2. **[Kartu](/platform/features/records)**: Ini mewakili tugas atau item kerja individu. Setiap kartu biasanya berisi informasi tentang tugas, seperti deskripsinya, siapa yang bertanggung jawab, dan tanggal jatuh temponya.
...
Kisah Kanban dimulai di pabrik-pabrik yang ramai di Jepang pasca-Perang Dunia II, khususnya di Toyota Motor Corporation. Pada akhir 1940-an, seorang insinyur industri muda bernama [Taiichi Ohno](https://en.wikipedia.org/wiki/Taiichi_Ohno) ditugaskan untuk meningkatkan efisiensi manufaktur Toyota. 

![](/insights/taiichi-ohno.jpg)

Ohno mengidentifikasi tujuh sumber pemborosan dalam produksi, yang sekarang diakui sebagai hal yang penting dalam [manufaktur ramping](https://en.wikipedia.org/wiki/Lean_manufacturing):

1. Penundaan, menunggu atau waktu yang dihabiskan dalam antrean tanpa nilai yang ditambahkan
2. Memproduksi lebih dari yang Anda butuhkan
3. Pemrosesan berlebihan atau melakukan aktivitas yang tidak menambah nilai
4. Transportasi
5. Gerakan atau gerakan yang tidak perlu
6. Inventaris
7. Cacat dalam Produk
...
2. Pertama katakan, "Saya bisa melakukannya." Dan coba sebelum segalanya.
3. Tempat kerja adalah guru. Anda hanya dapat menemukan jawaban di tempat kerja.
4. Lakukan apa pun segera. Memulai sesuatu sekarang adalah satu-satunya cara untuk menang.
5. Setelah Anda memulai sesuatu, tetaplah pada itu. Jangan menyerah sampai Anda menyelesaikannya.
6. Jelaskan hal-hal yang sulit dengan cara yang mudah dipahami. Ulangi hal-hal yang mudah dipahami.
7. Pemborosan tersembunyi. Jangan sembunyikan. Buat masalah terlihat.
8. Gerakan yang tidak bernilai sama dengan mempersingkat umur seseorang.
9. Perbaiki kembali apa yang telah diperbaiki untuk perbaikan lebih lanjut.
10. Kebijaksanaan diberikan secara merata kepada semua orang. Intinya adalah apakah seseorang dapat menggunakannya.
...
Eksperimen Anderson berhasil. Tim melihat [perbaikan dramatis dalam produktivitas dan moral](/insights/great-teamwork). Ini menandai lahirnya apa yang kemudian dikenal sebagai "Kanban untuk kerja pengetahuan" atau "Software Kanban."
...
Tonggak penting dalam penyebaran Kanban dalam pengembangan perangkat lunak dan seterusnya adalah peluncuran [Trello](/insights/trello) pada tahun 2011. Trello, sebuah [platform manajemen proyek berbasis web](/solutions/use-case/project-management), mempopulerkan konsep [papan Kanban digital](/platform/features/kanban-board) untuk audiens yang luas.
...
Keberhasilan Trello memicu gelombang alat serupa, seperti [Blue](/), dan segera, fitur papan Kanban menjadi penawaran standar di banyak [solusi perangkat lunak manajemen proyek](/solutions/use-case/project-management):
...
Saat Kanban terus berkembang di dunia perangkat lunak, ia mulai memengaruhi praktik manajemen proyek di berbagai industri. [Bahkan manajer non-proyek mulai menjadi manajer proyek!](/insights/project-management-basics-guide)
...
Di [Blue](/), kami secara aktif membangun masa depan papan Kanban, dan inilah sebabnya mengapa penting untuk memahami sejarah mereka. Saat kami bekerja untuk memenuhi misi kami untuk membangun [perangkat lunak manajemen proyek terbaik di dunia.](/solutions/use-case/project-management), kami melihat beberapa tren yang akan datang di masa depan:
...
Jadi itu saja! Kami berharap Anda menikmati belajar tentang sejarah papan Kanban. Jika Anda sedang mencari untuk menerapkan perangkat lunak papan kanban di tim Anda, [silakan mendaftar untuk percobaan gratis Blue.](https://app.blue.cc) 
