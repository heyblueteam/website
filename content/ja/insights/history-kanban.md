...
広く採用されているにもかかわらず、カンバンには誤解もあります。一部の人々は、それを設定するのが難しいか、常に長い文書計画や[Ganttチャート](/platform/features/timeline-gantt-charts)を必要とする「真剣な作業」に対して十分に強力ではないと誤解しています。実際には、カンバンのシンプルさはその最大の強みの一つであり、さまざまな規模や複雑さの作業に適応可能です。
