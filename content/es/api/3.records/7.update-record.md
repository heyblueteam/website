...
| startedAt/duedAt | DateTime | Fechas de inicio/finalización actualizadas en formato ISO 8601 |  |
...
Para actualizar los valores de los campos personalizados, use la mutación `setTodoCustomField` con parámetros específicos de campo:
...
5. Todas las operaciones de actualización activan el registro de actividad y las notificaciones de webhook