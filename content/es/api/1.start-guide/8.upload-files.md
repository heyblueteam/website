...
description: Guía completa para cargar archivos en Blue utilizando mutaciones de GraphQL o la API REST
---
...
1. **Carga Directa de GraphQL** (Recomendado) - Carga simple de un solo paso con un límite de tamaño de archivo de 256MB
2. **Carga de API REST** - Proceso de tres pasos que admite archivos más grandes de hasta 4.8GB
...
**Entrada:**
- `file: Upload!` - El archivo a cargar (usando multipart/form-data)
- `projectId: String!` - ID del proyecto o slug donde se almacenará el archivo
- `companyId: String!` - ID de la empresa o slug donde se almacenará el archivo

**Devuelve:** `File!` - El objeto de archivo creado
...
**Entrada:**
- `files: [Upload!]!` - Array de archivos a cargar (máx. 10)
- `projectId: String!` - ID del proyecto o slug donde se almacenarán los archivos
- `companyId: String!` - ID de la empresa o slug donde se almacenarán los archivos

**Devuelve:** `[File!]!` - Array de objetos de archivo creados
