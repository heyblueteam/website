---
title: La Historia de los Tableros Kanban
description: Aprende la historia de los Tableros Kanban y cómo evolucionaron de los pisos de fábrica a herramientas digitales flexibles.
category: "Best Practices"
date: 2024-07-23
---


En Blue, nos encantan los [tableros Kanban](/platform/features/kanban-board).
...
1. **[Listas (o Columnas)](https://documentation.blue.cc/records/lists)**: Estas representan las diferentes etapas en tu flujo de trabajo. Por ejemplo, un tablero Kanban básico podría tener listas etiquetadas como "Por Hacer", "En Progreso" y "Hecho".
2. **[Tarjetas](/platform/features/records)**: Estas representan tareas individuales o elementos de trabajo. Cada tarjeta contiene típicamente información sobre la tarea, como su descripción, quién es responsable de ella y su fecha de entrega.
...
La historia de Kanban comienza en las bulliciosas fábricas de Japón en la posguerra, específicamente en Toyota Motor Corporation. A finales de la década de 1940, un joven ingeniero industrial llamado [Taiichi Ohno](https://en.wikipedia.org/wiki/Taiichi_Ohno) fue encargado de mejorar la eficiencia de fabricación de Toyota.

![](/insights/taiichi-ohno.jpg)

Ohno identificó siete fuentes de desperdicio en la producción, que ahora se reconocen como cruciales en [la manufactura esbelta](https://en.wikipedia.org/wiki/Lean_manufacturing):

1. Retraso, espera o tiempo pasado en una cola sin que se agregue valor
2. Producir más de lo que necesitas
3. Procesamiento excesivo o realizar actividades que no agregan valor
4. Transporte
...
2. Primero di: "Puedo hacerlo." Y prueba antes de todo.
3. El lugar de trabajo es un maestro. Solo puedes encontrar respuestas en el lugar de trabajo.
4. Haz cualquier cosa de inmediato. Comenzar algo ahora mismo es la única forma de ganar.
5. Una vez que comiences algo, persevera con ello. No te rindas hasta que lo termines.
6. Explica cosas difíciles de una manera fácil de entender. Repite cosas que son fáciles de entender.
7. El desperdicio está oculto. No lo escondas. Haz los problemas visibles.
8. Los movimientos sin valor son equivalentes a acortar la vida de uno.
9. Re-mejora lo que fue mejorado para una mejora adicional.
10. La sabiduría se da por igual a todos. El punto es si uno puede ejercerla.
...
El experimento de Anderson fue un éxito. El equipo vio mejoras dramáticas en la [productividad y la moral](/insights/great-teamwork). Esto marcó el nacimiento de lo que se conocería como "Kanban para el trabajo del conocimiento" o "Kanban de Software".
...
Un hito significativo en la difusión de Kanban en el desarrollo de software y más allá fue el lanzamiento de [Trello](/insights/trello) en 2011. Trello, una [plataforma de gestión de proyectos basada en la web](/solutions/use-case/project-management), popularizó el concepto de [tableros Kanban digitales](/platform/features/kanban-board) para una amplia audiencia.
...
El éxito de Trello desató una ola de herramientas similares, como [Blue](/), y pronto, las características de tableros Kanban se convirtieron en una oferta estándar en muchas [soluciones de software de gestión de proyectos](/solutions/use-case/project-management):
...
A medida que Kanban continuó evolucionando en el mundo del software, comenzó a influir en las prácticas de gestión de proyectos en diversas industrias. [¡Incluso los no gerentes de proyectos comenzaron a convertirse en gerentes de proyectos!](/insights/project-management-basics-guide)
...
En [Blue](/), estamos construyendo activamente el futuro de los tableros Kanban, y por eso es tan importante entender su historia. A medida que trabajamos para cumplir nuestra misión de construir el [mejor software de gestión de proyectos del mundo](/solutions/use-case/project-management), vemos algunas tendencias que vienen en el futuro:
...
¡Así que eso es todo! Esperamos que hayas disfrutado aprendiendo sobre la historia de los tableros Kanban. Si estás buscando implementar un software de tablero kanban en tu equipo, [no dudes en registrarte para una prueba gratuita de Blue.](https://app.blue.cc) 
