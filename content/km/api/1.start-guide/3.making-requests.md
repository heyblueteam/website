---
title: ការធ្វើសំណើ
description: Blue API ប្រើ GraphQL ដើម្បីផ្តល់នូវវិធីសាស្រ្តដែលមានភាពបត់បែន និងមានប្រសិទ្ធភាពក្នុងការទំនាក់ទំនងជាមួយ API របស់យើង។
---

## ការអានទិន្នន័យ
អ្នកអាចចម្លង និងបិទបញ្ចូលកូដ curl ខាងក្រោមទៅក្នុង terminal របស់អ្នកដើម្បីចាប់ផ្តើម៖ .
...
```
ឬសាកល្បងឧទាហរណ៍ Python ឬ Node របស់យើង។
...
@@CB##d4aa3306-8e6c-411d-8295-96b3542c2843##CB@@json [Sample response for project list]
{
  "data": {
    "projectList": {
      "items": [
