...
- [Lists](/public/docs/records/lists): Sort records into different lists to categorize information. For example, have "To Do", "In Progress" and "Completed" lists.
- [Custom Fields](/public/docs/custom-fields): Add custom fields like dropdowns, numbers, and dates to capture specialized information. For example, add a "Lead Score" number field.
- [Tags](/public/docs/records/tags): Use colorful tags like "Urgent" or "Bug" to highlight priority records.
- [Comments](/public/docs/records/comments): Collaborate with your team by commenting directly on records.
- [Attachments](/public/docs/projects/file-management): Add files, images, videos directly to records for easy access.
- [Automations](/public/docs/automations): Trigger automations when records are created, edited or deleted. For example, send an email alert when a high priority record is generated.
