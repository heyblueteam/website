...
Another very useful feature is that Project Administrators can use  [Custom User Roles](/public/docs/user-management/roles/custom-user-roles) to restrict users to only see records that are specifically assigned to them.
