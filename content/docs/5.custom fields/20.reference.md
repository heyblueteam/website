...
Reference custom fields work alongside [Lookup custom fields](/public/docs/custom-fields/lookup) to bring information from one project into another. This is extremely powerful because it unlocks many use cases within Blue.
...
When creating a Reference field, the [Project Administrator](/public/docs/user-management/roles/project-administrator) selects the specific project that will provide the list of reference records.
