...
To ensure that the values on your Pie Chart are as relevant and targeted as possible, Blue offers robust filtering options — [any filter](/public/docs/views/filters) in any project view is available for use!
