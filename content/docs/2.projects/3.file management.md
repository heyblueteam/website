...
Files uploaded in the description area of the records are not listed in the files tab, as these are typically used for temporary notes. We recommend uploading files to a [specific file custom field](/public/docs/custom-fields/file) instead.
::

## File Custom Field

Blue has a [specific custom file field for handling structured data uploads](/public/docs/custom-fields/file). Files uploaded in this field will show on the file tab in the project and can be deleted from both the custom field within the record and the files tab.
...
Only [Project Administrators](/public/docs/user-management/roles/project-administrator) and [Team Members](/public/docs/user-management/roles/team-member) can delete files by right-clicking on a file and selecting delete.  A warning popup will appear to confirm the file deletion.
...
Folders are a valuable way to keep your file organised. [Project Administrators](/public/docs/user-management/roles/project-administrator) and [Team Members](/public/docs/user-management/roles/team-member) can create folders. You can create unlimited amounts of folders and sub-folders to match your organisational file structure.
...
Renaming a folder is simple: just right-click on the folder and select rename. Only  [Project Administrators](/public/docs/user-management/roles/project-administrator) and [Team Members](/public/docs/user-management/roles/team-member) can rename folders.
...
By default, folders are blue, but you can set a different color by right-clicking on the folder.  Only [Project Administrators](/public/docs/user-management/roles/project-administrator) and [Team Members](/public/docs/user-management/roles/team-member) can change the color of folders.
