...
Like [Documents](/public/docs/projects/documents), Wiki pages feature a rich text editor for easy formatting and content creation using toolbar options.
...
Like anywhere in Blue where you can drop comments, you can [@mention](/public/docs/user-management/mentions) team members to notify them or jump to their cursor location.
