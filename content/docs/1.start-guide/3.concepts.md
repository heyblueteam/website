...
We believe that everything is a process and that good processes lead to predictably good outcomes.
 ...
 While the idea of business processes can sound intimidating, we think this should be simple! The best way to create processes in Blue is to use a mix of [**Lists**](/public/docs/records/lists) and [Automations](/public/docs/automations).
...
- [Board View](/public/docs/views/board): The default kanban-style board allows you to structure your process by organizing records into lists representing each stage or step.
- [Calendar View](/public/docs/views/calendar): This calendar-based perspective makes tracking due dates, schedules, and temporal relationships across your records easy.
- [Database View](/public/docs/views/database): This view presents your records in an interactive spreadsheet-style table, enabling powerful filtering, sorting, and bulk editing capabilities for managing large datasets.
- [Timeline View](/public/docs/views/timeline-and-gantt-charts): The Gantt chart-style timeline gives you a visual overview of your records displayed chronologically, making it simple to track schedules, deadlines, and dependencies.
- [Map View](/public/docs/views/map): This geographic view plots records with location data onto an interactive map, unlocking unique insights based on spatial relationships and patterns.
- [List View](/public/docs/views/list): Providing a streamlined checklist interface, the List View simplifies progressive tracking through multi-step processes.
...
- [Project Administrators](/public/docs/user-management/roles/project-administrator): This is the highest-level role, granting full control over the project's settings, data, and user management. Project Admins can create custom roles, assign permissions, and have unrestricted access.
- [Team Members](/public/docs/user-management/roles/team-member): Users with the Team Member role have wide-ranging abilities to contribute to the project, including creating records, editing details, and managing the workflow. However, they are limited in actions like deleting the project or accessing administrative settings.
- [Clients](/public/docs/user-management/roles/client): The Client role is designed for external stakeholders, such as customers or partners, who must provide feedback and stay informed on project progress. Clients can view records and add comments but cannot make structural changes to the project.
- [Comment-Only](/public/docs/user-management/roles/comment-only): This role allows users to participate in discussions by adding comments, but they cannot create, edit, or delete any records or project elements.
- [View-Only](/public/docs/user-management/roles/view-only): Users with the View-Only role can see all project data, but they are restricted from making any modifications or contributing to the workflow.

In addition to the pre-defined user roles, Blue allows Project Administrators to create [Custom User Roles](/public/docs/user-management/roles/custom-user-roles) that can be tailored to their organisation's or project's specific needs. This enables fine-grained control over permissions and access levels.
